...
def you_forgot_something():
    ...
    # Your Answer: Single is saying something is what its equal to, but double is asking if it is equal then do this.
...
def giving_functions_the_wrong_stuff():
    ...
    my_int_2 = int("3") # What happens if we try to pass a non-number?
...
def make_your_own_error():
    ...
    x = 6 # Oops, this isn't between 1 and 10
